...
public class IndexationMain_tokenizer {
	...
	public static String out_index_words = "D:\\Users\\abdel\\Google Drive\\coursParisSud\\ExtractionInformation\\workspace\\REI_SE_TM\\SearchEngine\\index_words_tokenizer.txt";
	...
	public static void main(String[] args) {
		try {
			...
			File index_file = new File(index_dir + "\\index_tokenizer.txt");
